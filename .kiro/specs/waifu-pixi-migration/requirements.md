...
**当前进度：**
- `waifu-pixi-foundation` spec 已完成，基础渲染底座已跑通
- `frontend/live2d-test.html` 测试页面已实现模型选择、动作/表情控制、显示设置等功能
- 本 spec 基于测试页面的实现经验，将功能迁移到 React 主应用
...
- **foundation spec**: `waifu-pixi-foundation`，已完成的基础层 spec，提供渲染底座和模型加载能力。
- **live2d-test.html**: 测试页面，已验证模型选择、动作/表情控制、显示设置等功能。
